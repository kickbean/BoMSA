...
\caption{The average gradient Layer-1 Conv. during training. The gradients in DAG are consistently larger. This means that the gradients are effective back-propagated and thus, makes the model easier to train.}
