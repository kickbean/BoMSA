...
\caption{Our multi-scale DAG-CNN architecture is constructed by adding (marginalized) multi-scale output connections to an underlying {\em chain backbone} from the original CNN. \deva{Add Norm connections after average-pooling?}}
\label{fig:model}
\end{figure*}
