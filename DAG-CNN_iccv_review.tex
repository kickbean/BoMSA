...
Feature selection on Caffe-DAG selects layers 11,  13, 15, 18, and 20, making the final multiscale feature 9216-dimensional. Deep19-DAG selects layers 26, 28, 31, 33, and 30, for a final size of 6144. In both cases, our multiscale DAG features are {\em only 2X larger} than their single-scale counter part, making them practically easy to use and store.
...
\begin{figure*}[h!]
\centering
	\includegraphics[width=.7\textwidth]{fig/fig_more_eg.png}
