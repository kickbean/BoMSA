...
\begin{figure*}
\centering
	\subfigure[mid-level feature is preferred]{\includegraphics[width=.7\textwidth]{fig/moti_low_better.png}\label{fig:moti_low}}
	\subfigure[high-level feature is preferred]{\includegraphics[width=.7\textwidth]{fig/moti_high_better.png}\label{fig:moti_high}}
