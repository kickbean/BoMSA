...
Feature selection on Caffe-DAG selects layers 11,  13, 15, 18, and 20, for a total of 9216 feature dimensions, {\em making it only a factor of 2X larger} and so rather easy to use in practice. Similarly, feature selection on Deep19-DAG selects layers 26, 28, 31, 33, and 30, for a total of 6144 feature dimensions, {\em which is only 1.5X larger}.
