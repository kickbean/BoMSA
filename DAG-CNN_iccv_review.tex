...
Places~\cite{zhoulearning} (Caffe)	& 54.3	\\
MOP-CNN~\cite{Gong14} (Caffe) & 52.0 \\
FV~\cite{FV} & 47.2 \\
...
MOP-CNN~\cite{Gong14} (Caffe) & 68.9 \\
Places~\cite{zhoulearning} (Caffe)	& 68.2	\\
...
Place~\cite{zhoulearning} (Caffe) & 91.6 \\
