...
\begin{figure*}
\centering
	\subfigure[mid-level feature is preferred]{\includegraphics[height=.252\textwidth]{fig/moti_low_better.png}\label{fig:moti_low}}
	\subfigure[high-level feature is preferred]{\includegraphics[height=.252\textwidth,clip=true,trim=70mm 0mm 0mm 0mm]{fig/moti_high_better.png}\label{fig:moti_high}}
